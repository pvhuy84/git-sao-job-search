...
<body>
	...
	<div class="container text-center">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<input class="form-control" placeholder="nhập tên công ty của bạn"
					id="inputdefault" type="text">
			</div>
			<div class="col-sm-3"></div>
			<br>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<input class="form-control" placeholder="nhập địa chỉ của bạn"
					id="inputdefault" type="text">
			</div>
			<div class="col-sm-3"></div>
			<br>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<input class="form-control" placeholder="nhập www.yourcompany.com"
					id="inputdefault" type="text">
			</div>
			<div class="col-sm-3"></div>
			<br>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<input class="form-control" placeholder="nhập số điện thoại di động"
					id="inputdefault" type="text">
			</div>
			<div class="col-sm-3"></div>
			<br>
