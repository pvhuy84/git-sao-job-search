...
<body>
	...
	<div class="container text-center">
		...
		<form method="post" action="<%=request.getContextPath() + "/services/addjobseeker"%>">
			<div class="row">
				<h3 align="left">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<input class="form-control" placeholder="nhập password"
						name="password" id="inputdefault" type="password">
				</div>
				<div class="col-sm-3"></div>
				<br>
			</div>
			<div class="row">
				...
				<div class="col-sm-3">
					<input class="form-control" placeholder="nhập lại password"
						name="repassword" id="inputdefault" type="password">
				</div>
				<div class="col-sm-3"></div>
				<br>
				<h3></h3>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<input class="form-control" placeholder="nhập có dấu"
						name="fullname" id="inputdefault" type="text">
				</div>
				<div class="col-sm-3"></div>
				<br>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<input class="form-control" placeholder="nhập số điện thoại"
						name="phonenumber" id="inputdefault" type="text">
				</div>
				<div class="col-sm-3"></div>
				<br>
				<h3></h3>
