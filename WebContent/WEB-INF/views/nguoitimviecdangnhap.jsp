	...
	<div class="container text-center">
		...
		<div class="row">
			<h3 align="left">
				...
				đăng nhập <span class="Success Label"></span>
			</h3>
			<br>
		</div>
		...
		<div class="row">
			...
			<a href="#" role="button" type="submit"
				class="btn btn-primary active navb-right">Đăng nhập</a> <a href="#"
				role="button" type="button"
				class="btn btn-primary active navb-right">Quên mật khẩu</a>
		</div>
	</div>
	<br>
