...
<div class="container">
   <div class="test">
      ...
      <div class="row">
  <h3 align="left"><span class="glyphicon glyphicon-briefcase"></span>  Người tìm việc đăng nhập <span class = "Success Label"></span></h3>
    <br>
     </div>
     ...
     <h4>Thông tin đăng nhập</h4>
      ...
      <br>
      <h3></h3>
       <a href="#" role="button" type="submit" class="btn btn-primary active navb-right">Đăng nhập</a>
        <a href="#" role="button" type="button" class="btn btn-primary active navb-right">Quên mật khẩu</a>
      </div>
